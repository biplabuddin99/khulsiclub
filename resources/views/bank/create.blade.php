                              ...
                              @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                                        ...
                                        <input type="number" value="{{ old('account_number')}}" class="form-control" name="account_number" required>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                                        <label for="bank" ><b>{{__('Routing Number')}}<span class="text-danger">*</span></b></label>
                                        <input type="number" value="{{ old('routing_number')}}" class="form-control" name="routing_number" required>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                                        <label for="bank" ><b>{{__('Account Number')}}<span class="text-danger">*</span></b></label>
                                        <input type="number" value="{{ old('account_name')}}" class="form-control" name="account_name" required>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
