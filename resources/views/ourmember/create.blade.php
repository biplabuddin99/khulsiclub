        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{route(currentUser().'.ourMember.store')}}">
                            @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-12 col-md-12">
                                                <div class="form-group py-2">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ old('vill')}}" name="vill">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-12 col-md-12">
                                                <div class="form-group py-2">
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-md-12">
                                                <div class="form-group py-2">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ old('postalCode')}}" name="postalCode">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-6 col-md-12">
                                                <div class="form-group py-2">
