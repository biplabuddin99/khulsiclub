                              ...
                              @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        <textarea name="video_caption" class="form-control" rows="2">{{ old('video_caption')}}</textarea>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <label for="text"><b>{{__('Image Caption')}}</b></label>
                                        <textarea name="image_caption" class="form-control" rows="2">{{ old('image_caption')}}</textarea>
                                    </div>
                                    {{-- <div class="col-lg-4 col-md-6 col-sm-12">
