            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive">
                        ...
                        <a class="float-end" href="{{route(currentUser().'.creason.create')}}"style="font-size:1.7rem"><i class="bi bi-plus-square-fill"></i></a>
                            <thead>
                            ...
                            <tbody>
                                ...
                                <th scope="row">{{ ++$loop->index }}</th>
                                    ...
                                    <td class="white-space-nowrap">
                                        ...
                                        <form id="form{{$b->id}}" action="{{route(currentUser().'.creason.destroy',encryptor('encrypt',$b->id))}}" method="post">
                                            @csrf
                                            @method('delete')
