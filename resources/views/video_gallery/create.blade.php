            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.vgallery.store')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="caption">Caption:</label>
                                            <input type="text" id="caption" class="form-control" value="{{ old('caption')}}" name="caption">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="videoId"
                                                placeholder="video Id" name="videoId" rows="3" {{ old('videoId')}}>
                                        </div>
                                    </div>
