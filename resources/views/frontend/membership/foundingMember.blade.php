...
<section class="about-support d-none d-sm-block">
    ...
    <div class="container-fluid px-5">
        <div class="row">
            <div class="col-lg-6">
                <h3 class="mb-0 common-title-of-page">Founding Committee List</h3>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 text-center">
                <h3 class="mb-2 common-title-of-page">Founding Committee List</h3>
            </div>
            <div class="col-lg-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-end bg-transparent mb-0">
            ...
            <div class="sidebar-menu vue-affix affix-top ">
                <div class="leftside-menu">
                    <div class="card shadow border-0  pb-4 me-4 rounded-10">
                        ...
                        <ul class="sideber-nav fontend-sidebar-nav p-0 flex-culumn">
                        @php 
                            $curl=request()->path();
