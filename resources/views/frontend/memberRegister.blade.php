                ...
                <form class="form" method="post" enctype="multipart/form-data" action="{{route('memberRegister.store')}}">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12 py-2">
                        <div class="form-group">
                            ...
                            <input type="password" id="company" class="form-control" onfocus="this.placeholder = ''" value="{{ old('company')}}" onblur="this.placeholder = 'Re-type your password'" name="password_confirmation" style="background-color: transparent;">
                        </div>
                    </div>
                    <div class="col-12 py-2">
                        <div class="form-group">
