                            ...
                            <button class="navbar-toggler m-0" type="button" data-bs-toggle="collapse" data-bs-target="#memberNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                                ...
                                <div id="memberNav" class="navbar-collapse collapse">
                                    <ul class="nav flex-column w-100">
                                        ...
                                        <li class="nav-item"><i class="bi bi-chevron-double-right"></i><a class="nav-link" id="side-2-menu" href="{{route('member.profile')}}">Profile Update</a></li>
                                        <li class="nav-item"><i class="bi bi-chevron-double-right"></i><a class="nav-link" id="side-3-menu" href="{{route('member.registration.success')}}">Print Form</a></li>
